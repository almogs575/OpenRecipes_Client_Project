    ...
    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
      <div class="textbox">
        ...
        <b-form-group id="input-group-username" label-cols-sm="3" label="Username:" label-for="username" style="font-weight: bold;">
          <b-form-input id="username" v-model="$v.form.username.$model" type="text" :state="validateState('username')" style="border-bottom: 4px solid blue;"></b-form-input>
        ...
        <b-form-group id="input-group-country" label-cols-sm="3" label="Country:" label-for="country" style="font-weight: bold;">
          <b-form-select id="country" v-model="$v.form.country.$model" :options="countries" :state="validateState('country')" style="border-bottom: 4px solid blue;"></b-form-select>
        </b-form-group>
        <p class="h5 mb-2">
        ...
        <b-form-group id="input-group-Password" label-cols-sm="3" label="Password:" label-for="password" style="font-weight: bold;">
          ...
          <b-form-invalid-feedback tooltip v-if="$v.form.password.required && !$v.form.password.strongPassword">
      ...
      <b-button type="submit" style="width: 250px;" class="ml-5 w-75">Register</b-button>
      <div class="mt-2">
        <h4>
          Already a member?
        </h4>
